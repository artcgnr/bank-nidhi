...
import { currentUser, companyDetails } from "./utils.js";

const firmDetails = await companyDetails();
const companyBranch = firmDetails.companyName;

if (companyBranch) {
  document.getElementById('branchNamehid').textContent = companyBranch;
}
